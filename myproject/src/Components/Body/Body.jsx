...
Type:"SunGlases"
  ...
  return (
    <>
    <div className='card_top__div'><p className='card__cat'>CATEGORIES FOR YOU</p>
      <div class="card__div">
      {
        obj.map((cur=>{
          return  <button className='card__outer'>
          <img className='card__img' src={cur.src}></img>
          <div className='card__text'><p class='card__text__value'>{cur.Type}</p></div>
                  </button>
        }))
      }
